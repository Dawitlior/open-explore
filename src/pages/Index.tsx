    ...
    <div dir={isRTL ? 'rtl' : 'ltr'} className="orca-app-shell" style={{ display: 'flex', height: '100dvh', width: '100%', minWidth: 0, overflow: 'hidden', background: T.bg.primary, color: T.text.primary, fontFamily: "'Inter', system-ui, -apple-system, sans-serif", fontSize: 14, transition: 'background 0.5s ease, color 0.5s ease' }}>
        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '6px 18px 14px', flexShrink: 0 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <img src="/orcaIcon.ico" alt="Orca Investment" width={44} height={44} style={{ display: 'block', width: 44, height: 44, objectFit: 'contain' }} />
              </div>
              <button
                onClick={() => setSbOpen(false)}
      ...
      <aside data-app-sidebar style={{
        ...
        <div style={{ padding: '18px 14px 6px', display: 'flex', alignItems: 'center', gap: 10 }}>
          <div style={{ cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', width: 34, height: 34, flexShrink: 0 }} onClick={() => setShowFeatureModal(true)}>
            <img src="/orcaIcon.ico" alt="Orca Investment" width={34} height={34} style={{ display: 'block', width: 34, height: 34, objectFit: 'contain' }} />
          </div>
      ...
      <MainPullToRefresh isMobile={isMobile} accent={infoColor(T)}>
        ...
        <div className={isMobile ? 'orca-mobile-pad-bottom' : ''} style={{ padding: isMobile ? '12px 10px' : '20px 24px', maxWidth: 1400, width: '100%', minWidth: 0, boxSizing: 'border-box', overflowX: 'hidden', margin: '0 auto' }}>
          {trades.length === 0 && page !== 'weekly-review' && page !== 'economic-radar' && page !== 'ai' && (
            <EmptyStateImportCTA
              T={T}
              isRTL={isRTL}
