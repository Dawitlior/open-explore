// Trading theme constants - inline style values matching the design system
export const T = {
...
export const ttStyle = { background: T.bg.card, border: `1px solid ${T.border.medium}`, borderRadius: T.radius.md, color: T.text.primary, fontSize: 12 };

export const modeColors: Record<string, string> = { live: T.accent.green, review: T.accent.blue, research: T.accent.purple, recovery: T.accent.orange };
