...
const TCard = ({ trade, idx, onChange, onDel, f, dir, disabled, th }: any) => {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 8, marginBottom: 10 }} className="j-grid-2col">
...
const MorningLockOverlay = ({ onDone, isRTL }: { onDone: () => void; isRTL: boolean }) => {
  ...
  return (
    <div style={{
      ...
      display: 'flex', alignItems: 'center', justifyContent: 'center',
      overflow: 'hidden', width: '100%', height: '100dvh',
    }}>
      <div style={{
        position: 'absolute', inset: 0,
...
const EODLockOverlay = ({ onDone, isRTL }: { onDone: () => void; isRTL: boolean }) => {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 9998, pointerEvents: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', width: '100%', height: '100dvh', maxWidth: '100%' }}>
