...
// IBKR Flex Query ID: numeric string (typically 6-10 digits).
const IBKR_QUERY_ID = /^\d{4,12}$/;
// IBKR Flex Token: long alphanumeric string generated by IBKR.
const IBKR_TOKEN = /^[A-Za-z0-9]{16,512}$/;
